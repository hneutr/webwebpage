...
{% assign webweb_json=site.data.examples.networkx_simple.json | jsonify %}
...
```python
{{site.data.examples.networkx_simple.representations.python}}
```
<div id='json-code-block' class='select-code-block'></div>
```json
{{site.data.examples.networkx_simple.representations.json}}
```